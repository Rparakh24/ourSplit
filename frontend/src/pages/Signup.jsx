  ...
  return (
    <div className="bg-gray-300 h-screen flex justify-center items-center">
        <div className="h-4/5 w-96 bg-white rounded-3xl flex flex-col items-center ">
            <Heading className={"text-5xl font-bold mt-10"} text={"SignUp"}></Heading>
            <Subheading text={<>Enter your information to create <br/> an account</>}></Subheading>
            ...
            <Button onClick={addUser} className={"w-80 h-10 mt-5 text-white bg-black rounded-lg"} text={"SignUp"}></Button>
            <div className="flex mt-7">
              <p className=" font-sans font-normal">Already have an account?</p>
              <Linkto to={"/signin"} text={"Signin"} className="pointer underline pl-1 cursor-pointer"></Linkto>
            </div>
        </div>
    </div>
  );
